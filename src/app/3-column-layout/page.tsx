  ...
  return (
    ...
    >
      <div className="flex justify-center m-20 flex-col md:flex-row md:w-[920px] md:h-[500px]">
        <div className="bg-orange-400 min-w-[200px] min-h-[400px] rounded-t-md  md:rounded-l-md md:rounded-tr-none pl-10 flex flex-col justify-around items-start">
        ...
        <div className="bg-teal-700 min-w-[200px] min-h-[400px] pl-10 flex flex-col justify-around items-start">
          <svg width="64" height="40" xmlns="http://www.w3.org/2000/svg">
            <g fill="none" fillRule="evenodd">
              <circle fill="#000" opacity=".201" cx="20" cy="20" r="20" />
              <path
        ...
        <div className="bg-emerald-900 min-w-[200px] pl-10 rounded-b-md md:rounded-r-md md:rounded-bl-none flex flex-col justify-around items-start min-h-[400px]">
          <svg width="64" height="40" xmlns="http://www.w3.org/2000/svg">
            <g fill="none" fillRule="evenodd">
              <circle fill="#000" opacity=".201" cx="20" cy="20" r="20" />
              <path
